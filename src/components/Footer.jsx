...
const Footer = () => {
  return (
    <>
      <footer class="text-gray-600 bg-[#0f0f0f] body-font">
        <div class="container px-5 py-8 mx-auto flex items-center sm:flex-row flex-col">
          <img src={img1} alt="" className="w-[8%]" />
          <p class="text-sm text-[#999999] font-normal sm:ml-4 sm:pl-4 sm:border-l-2 sm:text-[#999999]  sm:py-2 sm:mt-0 mt-4">
